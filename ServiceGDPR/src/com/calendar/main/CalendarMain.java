...
public class CalendarMain {
	public static Stage primaryStageCalanderMain;
	public static Stage primaryStageCalanderTableMain;

	public void startCalendar() {
		try {
			Parent root = FXMLLoader.load(getClass().getResource("/com/calendar/view/Calendar.fxml"));
			Stage stage = new Stage();
			primaryStageCalanderMain = stage;
	...
	public void startTable() {
		try {
			...
			primaryStageCalanderTableMain = primaryStage;
