...
public class CompanyFXMLController implements Initializable {
	...
	private void clientCheckTable() {
		...
		companyName.setCellValueFactory(new PropertyValueFactory<Client, String>("clientName"));
	...
	private void btnCompanyCheck() {
		if (setClientCheckTxt()) {
			...
			clientCheckTable();
			dataCompany.clear();
			dataCompany.addAll(ClientFillteringDB.getClientNameFilltering(txtClientInputClientName.getText()));
