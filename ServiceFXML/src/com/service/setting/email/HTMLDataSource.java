...
public class HTMLDataSource implements DataSource {
	...
	protected static String deviceStatusz;
	...
	public static String getHTMLContent() {
		...
		String html = "<html><hr />"
				...
				+ "<td style=\"width: 239px; text-align: right; background-color: #424242;\"><span style=\"color: whitesmoke;\">C&eacute;g:</span></td>"
				+ "<td style=\"width: 501px; text-align: left; background-color: #424242;\"><span style=\"color: whitesmoke;\">&nbsp;"
				...
				+ "<td style=\"width: 239px; background-color: #424242; text-align: right;\">&nbsp;<span style=\"color: whitesmoke;\">Hiba Le&iacute;r&aacute;s:</span></td>"
				+ "<td style=\"width: 501px; background-color: #424242;\"><span style=\"color: whitesmoke;\">&nbsp;"
				...
				+ "<td style=\"width: 239px; text-align: right; background-color: #424242;\"><span style=\"color: whitesmoke;\">Eszk&ouml;zről megjegyz&eacute;s:</span></td>"
				+ "<td style=\"width: 501px; text-align: left; background-color: #424242;\"><span style=\"color: whitesmoke;\">&nbsp;"
				...
				+ "<td style=\"width: 239px; background-color: #424242; text-align: right;\">&nbsp;<span style=\"color: whitesmoke;\">Elk&eacute;sz&uuml;lt:</span></td>"
				+ "<td style=\"width: 501px; background-color: #424242;\"><span style=\"color: whitesmoke;\">&nbsp;"
				+ deviceCompletedDate + "</span></td>" + "</tr>" + "<tr>"
				+ "<td style=\"width: 239px; background-color: #616161; text-align: right;\">&nbsp;<span style=\"color: whitesmoke;\">Szoftver:</span></td>"
				+ "<td style=\"width: 501px; background-color: #616161;\"><span style=\"color: whitesmoke;\">&nbsp;"
